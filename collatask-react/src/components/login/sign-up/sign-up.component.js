...
export default class SignUpComponent extends React.Component {
    render() {
        return (
            <Form>
                <Form.Group as={Row} controlId="register.email" required>
                    <Form.Label>Email Address</Form.Label>
                    <Form.Control type="email" placeholder="name@example.com"></Form.Control>
                </Form.Group>
                <Form.Group as={Row} controlId="register.password" required>
                    <Form.Label>Password</Form.Label>
                    <Form.Control type="password" placeholder="Must be 6 characters or more"></Form.Control>
                </Form.Group>
                <Form.Group as={Row} controlId="register.confirmpw" required>
